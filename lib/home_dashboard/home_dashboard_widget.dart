...
import '/components/change_power_widget.dart';
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<List<SensorsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<SensorsRecord> textSensorsRecordList =
                                snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            ...
                            final textSensorsRecord =
                                textSensorsRecordList.isNotEmpty
                                    ? textSensorsRecordList.first
                                    : null;

                            return Text(
                              valueOrDefault<String>(
                                textSensorsRecord?.modeAktif,
                                'Unknown',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
